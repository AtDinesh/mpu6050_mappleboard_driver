...
#ifndef _mpu6050_mappleboard_driver_node_h_
#define _mpu6050_mappleboard_driver_node_h_
 ...
 *
 */
class Mpu6050MappleboardDriverNode
{
  private:
    ...
    */
    Mpu6050MappleboardDriverAlgorithm alg_;
  ...
  public:
    ...
    */
    Mpu6050MappleboardDriverNode(ros::NodeHandle &nh, dynamic_reconfigure::Server<Config> &dsrv);
    ...
    * this class.
    */
    ~Mpu6050MappleboardDriverNode(void);
